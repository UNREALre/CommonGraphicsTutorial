...
class CoolTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        self.thingsToLearn = ["Maths", "English", "German", "Computer Science"]
        self.thingsLearned = ["Geometry", "Literature", "IOS"]
    }
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        if indexPath.section == 0 {
            cellContent = self.thingsToLearn[indexPath.row]
        }
        else {
            cellContent = self.thingsLearned[indexPath.row]
        }
